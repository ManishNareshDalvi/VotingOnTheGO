...
<body>
  ...
  <main id="main" class=" alert-info">
        ...
        <h2 class="text-center">Voter Log in</h2>       
        <div class="form-group first_box">
            <input type="text" id="email" class="form-control" placeholder="Email" required="required"><br>
        ...
        <div class="form-group second_box">
            <input type="text" id="otp" class="form-control" placeholder="Enter OTP received by Mail" required="required"><br>
