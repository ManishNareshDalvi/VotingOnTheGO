...
<div class="containe-fluid">
	...
	<div class="row">
		<div class="col-lg-8">
			<div id="block1" class="card col-md-3 offset-2  float-left">
			...
			<div id="block2" class="card col-md-3.5 offset-2  ml-4 float-left">
				<div class="card-body text-white">
							...
							<div class="row mt-3">
								...
								?>
									<div class="candidate" style="position: relative;">
										<div class="img-field">
										<center>	<img src="assets/img/<?php echo $candidate['image_path'] ?>" alt=""></center>
										</div class="">
										<div class="candidate_name text-center"><b>Candidate Name :</b> <?php echo $candidate['opt_txt'] ?></div>
										<div class="candidate_name text-center"><b>Gender :</b> <?php echo $candidate['gender'] ?></div>
										<div class="candidate_name text-center"><b>Political Party :</b> <?php echo $candidate['political_party'] ?></div>
										<div class="candidate_name text-center"><b>Total Votes :</b> <?php echo isset($v_arr[$candidate['id']]) ? number_format($v_arr[$candidate['id']]) : 0  ?></div>
