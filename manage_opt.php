	...
	<div class="col-lg-12">
		<form action="" id="manage-opt">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="opt_txt" value="<?php echo isset($opt_txt) ? $opt_txt :'' ?>" required>
			</div>
			<div class="form-group">
				<label for="" class="control-label">Gender</label>
				<input type="text" class="form-control" name="gender" value="<?php echo isset($gender) ? $gender :'' ?>" reqrequireduired>
			</div>
			<div class="form-group">
				<label for="" class="control-label">Political Party</label>
				<input type="text" class="form-control" name="political_party" value="<?php echo isset($political_party) ? $political_party :'' ?>" reqrequireduired>
			</div>
			<div class="form-group">
				<label for="" class="control-label">Candidate Image</label>
